            ...
            <div className="text-center desktop-flex-col desktop-flex-stretch">
                <div className="clearfix">
                    <Col {...colProps}>
                        ...
                        <p>
                            <FormattedMessage id="auth.havekey.desc" defaultMessage="If you are already familiar with Genesis and have a backup of your private key - choose this option to guide you through the process of restoring of your account data" />
                        </p>
