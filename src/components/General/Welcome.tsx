...
const Welcome: React.SFC<IWelcomeProps> = (props) => (
    <General>
        <div className="text-center">
            <h4>Welcome to Apla</h4>
            <p className="pv">Before proceeding, you will now be guided through the account creation process. This will not take too much of your time. After completing this process you will be able to use all features of Apla</p>
