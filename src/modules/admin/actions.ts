...
// Constructor
export const loadTabList = actionCreator<{ add_id?: string}>('LOAD_TAB_LIST');
export const addTabList = actionCreator<{ id: string }>('ADD_TAB_LIST');
export const removeTabList = actionCreator<{ index: number }>('REMOVE_TAB_LIST');
